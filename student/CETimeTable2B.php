...
<div style="width:990px;height:500px;border:2px solid black;border-radius:5px 5px 5px 5px;">
...
<tr>
	...
	<tr>
		...
		<td style="text-align:center;">  <?php echo $sname[5]; ?> </td>
	</tr>
	<tr>
		<th> Tuesday </th>
		<td style="text-align:center;">  <?php echo $fill; ?> </td>
		...
		<td style="text-align:center;">  <?php echo $sname[1]; ?> </td>
		<td style="text-align:center;" colspan="2">  <?php echo $lname[5]; ?> </td>
	</tr>
	<tr>
		<th> Wednesday </th>
