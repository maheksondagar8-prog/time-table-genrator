...
$q = "SELECT * FROM subj_ce where sem='$sem' limit 4";
...
<tr>
	...
	<tr>
		...
		<td style="text-align:center;" colspan="2">  <?php echo $sname[0]; ?> </td>
	...
	<tr>
		...
		<td style="text-align:center;" colspan="2">  <?php echo $sname[1]; ?> </td>
		<td style="text-align:center;" colspan="2">  <?php echo $sname[2]; ?> </td>
		<td style="text-align:center;" class="red"> E </td>
		<td style="text-align:center;">  <?php echo $sname[1]; ?> </td>
		<td style="text-align:center;" colspan="2">  <?php echo $sname[3]; ?> </td>
	</tr>
	<tr>
		<th> Wednesday </th>
