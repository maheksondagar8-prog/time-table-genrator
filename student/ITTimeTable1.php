...
$q = "SELECT * FROM subj_it where sem='$sem' limit 3";
...
$q1 = "SELECT * FROM subj_it where sem='$sem' limit 3";
...
<tr>
	...
	<tr>
		<th> Wednesday </th>
		<td style="text-align:center;" colspan="3"> <?php echo $lname[0]."( ".$lid[0]." )" ; ?> </td>
		<td style="text-align:center;">  <?php echo $sid[0]; ?> </td>
	...
	<tr>
		...
		<td style="text-align:center;">  <?php echo $fill; ?> </td>
		<td style="text-align:center;" class="red"> E </td>
		<td style="text-align:center;" colspan="3"> <?php echo $lname[1]."( ".$lid[1]." )" ; ?> </td>
	</tr>
	<tr>
		<th> Friday </th>
		<td style="text-align:center;" colspan="3"> <?php echo $lname[2]."( ".$lid[2]." )" ; ?> </td>
		<td style="text-align:center;">  <?php echo $sid[0]; ?> </td>
