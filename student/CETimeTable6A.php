...
$arr = array(1=>"First Semester","Second Semester","Third Semester","Fourth Semester","Fifth Semester","Six Semester");

$q = "SELECT * FROM subj_ce where sem='$sem' limit 6";
...
<div style="width:900px;height:580px;border:2px solid black;border-radius:5px 5px 5px 5px;">
...
<tr>
	...
	<tr>
		...
		<td style="text-align:center;" colspan="2">  <?php echo $lname[1]; ?> </td>
		<td style="text-align:center;" colspan="2">  <?php echo $lname[3]; ?> </td>
	</tr>
	<tr>
		<th> Wednesday </th>
	...
	<tr>
		...
		<td style="text-align:center;">  <?php echo $sname[2]; ?> </td>
		<td style="text-align:center;" class="red"> S </td>
		<td style="text-align:center;" colspan="2">  <?php echo $fill; ?> </td>
		<td style="text-align:center;">  <?php echo $sname[3]; ?> </td>
	</tr>
	</table>
	</th>
