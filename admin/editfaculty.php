...
<form action="" method="post">
	...
	<div style="width:700px;">
		...
		<center><h2> Edit Faculty Panel </h2>
	<?php

	include("../config.php");

	$qq = "select * from faculty where fid='$id'";
	...
	if(isset($_POST['s1']))
	{
		...
		$qq = "UPDATE faculty SET name='$t2' where fid='$a'";

		$rr = mysqli_query($con,$qq);

		if($rr > 0)
		{
				echo "<script>alert('Record Edited Successfully');window.location='faculty.php';</script>";
		}
		else
		{
				echo "<script>alert('Error: Record Could not be edit');window.location='faculty.php';</script>";
		}
	}
