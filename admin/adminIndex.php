                                    ...
                                    <table height="100%" width="100%" style="color:#000000;text-align:justify;">
                                        <tr>
                                            <td height="100S%" width="90%">
                                                <h1>Welcome </h1>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time-Table Management System, our software allows users to generate time table 
												for newly occurringchanges in less time, with less effort and with more efficiency. It will allow usersto work on and view time tables in different platforms and view different information simultaneously. 
												Our aim here is to develop a simple, easily understandable, efficient and portableapplication, which could automatically generate good quality time tables within seconds.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="100%" width="90%">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="../images/arrow.jpg"> <a style="color:blue;" href="subj_ce.php"> CE Subject Panel </a> <br />
                                                <img src="../images/arrow.jpg"> <a style="color:blue;" href="subj_it.php"> IT Subject Panel </a> <br />
                                                <img src="../images/arrow.jpg"> <a style="color:blue;" href="allocateIT.php"> Allocate IT Subject </a> <br />
                                                <img src="../images/arrow.jpg"> <a style="color:blue;" href="allocateCE.php"> Allocate CE Subject </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
