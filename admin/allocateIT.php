...
<tr>
	...
	<div id="my" style="width:700px;">
		...
		<center><h2> Allocate IT Subject Panel </h2></center>
	...
	if(isset($_POST['s']))
	{
		...
		$q11 = "SELECT * from it WHERE cid='$b'";
		$r11 = mysqli_query($con,$q11) or die("not inserted");
		...
		{
			$q12 = "SELECT * from it WHERE slot='$c'";
			$r12 = mysqli_query($con,$q12) or die("not successful...");
			...
			{
				$q13 = "SELECT * from it WHERE fid='$a'";
				...
				{
					$q = "INSERT INTO it (fid,cid,slot) VALUES ('$a','$b','$c')";
