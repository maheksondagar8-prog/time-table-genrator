                    ...
                    <td style="width: 900px;">
                        <table style="width: 900px; height:20px" cellspacing="0">
                            <tr>
                                ...
                                <td style="height:20px;width:150px;"><a class="link" href="subject.php"> SUBJECTS </a></td>
                                <td style="height:20px;width:10px;">
...
<tr>
	...
	<input style="width:20px;" type="radio" name="r" value="0" onchange="a(this.value)"> Add News <br>
	<input style="width:20px;" type="radio" name="r" value="1" onchange="a(this.value)"> Edit News <br>
	<input style="width:20px;" type="radio" name="r" value="2" onchange="a(this.value)"> Delete News <br>
	</form>
