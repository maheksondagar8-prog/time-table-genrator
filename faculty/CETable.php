...
{
	echo "<script>alert('Error: CE Subjects are not Allocated to you');window.location='userIndex.php';</script></font>";
}
...
<h1> TimeTable For CE Classes </h1>
